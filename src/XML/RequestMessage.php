 ...
 * @version 1.0.0
 */
abstract class Pronamic_WP_Pay_Gateways_IDealAdvanced_XML_RequestMessage extends Pronamic_WP_Pay_Gateways_IDealAdvanced_XML_Message  {
	/**
	 * Merchant
	 *
	 * @var Merchant
	...
	public function __construct( $name ) {
		...
		$this->merchant = new Pronamic_WP_Pay_Gateways_IDealAdvanced_Merchant();
	}
